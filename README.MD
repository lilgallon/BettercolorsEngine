...
The engine takes into account the MC input design change of 1.13 and above (glfw vs awt), and works with **all versions of MC** (at least from 1.8.9 to 1.16.2). And should
