...
- **Forge < 1.13**: Use [Old forge (OF) version](https://github.com/N3ROO/BettercolorsEngine/tree/OF)
- **Forge >= 1.13**: Use [New forge (NF) version](https://github.com/N3ROO/BettercolorsEngine/tree/NF)
